...
![hello-world](notes/img/hello-world.gif)
...
![all-inputs](notes/img/all-inputs.png)
...
![slider](notes/img/slider-input.png)
...
![shinywidgets-gallery](notes/img/shiny-widgets-gallery.png)
...
Copy code for the app you just created and modify it by:
...
![theme-selector](notes/img/theme-selector.png)
...
![app-moma](notes/img/app-moma.gif)
